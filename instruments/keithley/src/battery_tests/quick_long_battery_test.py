...
discharge_voltage = 3.5    # Daha yüksek voltaj = daha kısa deşarj
discharge_current = 1.0    # Daha yüksek akım = daha hızlı deşarj
...
try:
    ...
    # Deşarj tamamlanana kadar bekle (max 3 dakika)
    wait_measurement_complete(inst, max_hours=0.05, poll_interval=10)
